...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { Name: @subject.Name, sem: @subject.sem, subID: @subject.subID } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { Name: @subject.Name, sem: @subject.sem, subID: @subject.subID } }
